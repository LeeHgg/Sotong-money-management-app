...
class AmountChangeChoiceScreen extends StatefulWidget {
  final List<dynamic> depositItems;

  const AmountChangeChoiceScreen({
    super.key,
    required this.depositItems,
  });

  @override
  State<AmountChangeChoiceScreen> createState() => _AmountChangeChoiceScreenState();
}

class _AmountChangeChoiceScreenState extends State<AmountChangeChoiceScreen> {
